...
**Commands**
I made a class "GalagaCommands" with the commands I'm using in my projects. This was made so I can use it for the move commands for
my spaceship and for my controller support(input). Using commands is very beneficial because it's an object-oriented language. It's an easy way
...
Github link: https://github.com/Karrietje/Galaga
